...
namespace Lab4
{
    public partial class Main : Form
    {
        ...
        {   
            models = Assembly.Load("NewPhoneModel");
            types = models.GetTypes().Where(type => type.GetInterface("Phone") != null && !type.IsAbstract);
        ...
        {
            if (method.GetParameters()[0].ParameterType.Name == "Phone")
